...
\PassOptionsToPackage{language=auto,style=numeric-comp,backend=biber,bibencoding=ascii,maxbibnames=50}{biblatex} % backend ggf. auf neueres Werkzeug (z.B. biber) anpassen
